...
// Email Subject
$config['subject']				= 'Misc Contact Form';	// subject of emails you receive
...
define('UPLOAD_FOLDER_URL',	'http://localhost/PRJ/Misc/HTML/php/_upload/');	// Full url path to upload folder (used for contact files) - slash at the end!
